...
def get_post_data(url):
    ...
    # 下载验证码图片
    pic = requests.get(
        'http://jwc.whut.edu.cn/(gxv2le55n4jswm45mkv14o2n)/CheckCode.aspx').content
...
def login(url,data):
    ...
    return s
base_url = 'http://jwc.whut.edu.cn/(gxv2le55n4jswm45mkv14o2n)/default2.aspx'
data = get_post_data(base_url)
print(data)
# 模拟登录教务系统
brow = login(base_url,data)
test = brow.get('http://jwc.whut.edu.cn/(gxv2le55n4jswm45mkv14o2n)/xs_main.aspx?xh=14200406101')
